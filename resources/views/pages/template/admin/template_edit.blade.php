        ...
        <div class="col-6">
            <form action="{{route('createTemplate')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" onkeyup="currencyFormat(this)" value="{{$data->harga_bias}}" name="harga_bias" class="form-control" id="exampleFormControlInput1" placeholder="">
                </div>
                ...
                <div>
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            <a href="{{asset($file)}}" type="button" class="btn btn-outline-info btn-sm">File {{$loop->iteration}}</a>
                            <a href="{{route('deleteFileTemplate',['id'=>$data->id,'index'=>$loop->iteration])}}" type="button" class="text-danger">Hapus</a>
                        </li>
                        @empty 
                        @endforelse
                    </ul>
