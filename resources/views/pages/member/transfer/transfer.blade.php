            ...
            <div class="card mb-4 d-block w-100 shadow-xss rounded-lg p-4 border-0">
                ...
                <div class="d-flex flex-column flex-sm-row justify-content-between">
                    ...
                    <div class="d-flex align-items-end">
                        @if($dt->status == 'lunas')
                        <a href="{{route('enrollProdukDetail',$dt->link)}}" class="mt-3 p-1 btn lh-24 w100 ml-1 ls-3 d-inline-block btn-sm bg-messenger font-xssss fw-700 ls-lg text-white">Lihat</a>
                        @endif
