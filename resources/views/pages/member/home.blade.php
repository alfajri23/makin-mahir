    ...
    <div class="container py-5 my-5">
        <div class="row justify-content-center">
            <div class="page-title style1 col-xl-8 col-lg-8 col-md-10 text-center mb-3">
                ...
                <p class="fw-300 font-xss lh-28 text-grey-600">Perlu Kirim 20 CV Lamaran Kerja 
                    Buat Dapat 1 Panggilan Interview.
        ...
        <div class="row align-items-stretch">
            <div class="col-lg-4 col-md-6">
                <a href="{{route('produkListEvent')}}" class="hover card w-100 h-100 border-0 p-4 shadow-xss rounded-lg aos-init" data-aos="zoom-in" data-aos-delay="100" data-aos-duration="500">
            ...
            <div class="col-lg-4 col-md-6">
                <a href="{{route('produkListKonsul')}}" class="hover card w-100 h-100 border-0 p-4 shadow-xss rounded-lg aos-init" data-aos="zoom-in" data-aos-delay="200" data-aos-duration="500">
