...
<div class="container pt-4">
    <div class="row justify-content-between my-4">
        <h4 class="text-dark font-weight-bold">Settings Beduk</h4>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="{{route('saveBeduk')}}" method="post" id="formBody" enctype="multipart/form-data">
                @csrf
...
<div class="modal fade" id="modalCreate" tabindex="1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="{{route('createBeduk')}}" method="post" id="formBody" enctype="multipart/form-data">
                @csrf
                <div class="form-group">
                  <label for="exampleInputEmail1">Nama</label>
