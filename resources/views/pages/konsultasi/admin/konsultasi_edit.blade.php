...
<div class="container">
    <div class="card-body mb-5">
        <div class="row no-gutters align-items-center">
            <img src="{{asset($data->poster)}}" style="max-width:100%" class="rounded" alt="">
        </div>
    </div>
    <div class="row">
        <div class="col-6">
        <form action="{{route('saveKonsultasi')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" name="jenis_konsultasi" value="{{$data->jenis_konsultasi}}" class="form-control" id="exampleFormControlInput1" placeholder="">
            </div>
        </div>
        ...
        <div class="col-12">
            ...
            <div class="mb-3">
                ...
                <select id="disabledSelect" name="id_pemateri" class="form-select">
                    <option value="{{$data->id_expert}}" selected>Pilih</option> 
