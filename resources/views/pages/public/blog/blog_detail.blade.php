...
<div class="col-12 col-sm-10 mx-auto pt-5 pt-sm-0">
    ...
    <div class="row">
        ...
        <a target="_blank" href="https://web.whatsapp.com/send?text={{url()->full()}}" class="btn-round-md ml-0 d-inline-block float-right rounded-lg bg-success mx-1" data-original-title="whatsapp" rel="tooltip" data-placement="left" data-action="share/whatsapp/share">
