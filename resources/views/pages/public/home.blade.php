        ...
        <div class="container">
              <div class="row">
                ...
                <div class="col-lg-4 offset-lg-1">
                    <span class="font-xsssss fw-700 pl-3 pr-3 lh-32 text-uppercase rounded-xl ls-2 alert-success d-inline-block text-success mr-1">Beduk</span>
                    <h2 class="text-grey-900 fw-700 display1-size pb-3 mb-0 mt-3 d-block lh-3 aos-init" data-aos="fade-up" data-aos-delay="200" data-aos-duration="500">Live Event Bedah Dunia Kerja (BEDUK)</h2>
                    ...
                    <a href="#" class="btn border-0 bg-primary p-3 text-white fw-600 rounded-lg d-inline-block font-xssss btn-light mt-3 w150 aos-init" data-aos="fade-up" data-aos-delay="400" data-aos-duration="500">Subscribe</a>
                </div>
              </div>
        </div>
    </div>
        ...
        <div class="container">
              <div class="row">
                ...
                <div class="col-lg-4 order-lg-1">
                    <span class="font-xsssss fw-700 pl-3 pr-3 lh-32 text-uppercase rounded-xl ls-2 alert-success d-inline-block text-success mr-1">Konsultasi</span>
                    <h2 class="text-grey-900 fw-700 display1-size pb-3 mb-0 mt-3 d-block lh-3 aos-init" data-aos="fade-up" data-aos-delay="200" data-aos-duration="500">Konsultasi Private Dengan HRD</h2>
