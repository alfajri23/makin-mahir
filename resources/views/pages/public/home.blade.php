                ...
                <div class="loop owl-carousel owl-theme owl-loaded owl-drag">
                    ...
                    <div class="owl-items text-center my-5">
                        <div class="card w-100 p-4 p-md--5 text-left border shadow-xs rounded-lg">
                            ...
                            <p class="font-xsss fw-400 text-grey-500 lh-28 mt-0 mb-0 ">
                    ...
                    <div class="owl-items text-center my-5">
                        <div class="card w-100 p-4 p-md--5 text-left border shadow-xs rounded-lg">
                            ...
                            <p class="font-xsss fw-400 text-grey-500 lh-28 mt-0 mb-0 ">“Saya jadi paham terkait pembuatan CV, baik yang ATS ataupun CV Kreatif. Terimakasih Makin Mahir”</p>
                        </div>
                    </div>
                    ...
                    <div class="owl-items text-center my-5">
                        <div class="card w-100 p-4 p-md--5 text-left border shadow-xs rounded-lg">
                            <div class="card-body pl-0 pt-0">
                                ...
                                <h5 class="font-xssss fw-500 mb-1 text-grey-500">Universitas Padjajaran</h5>
                            </div>
                            <p class="font-xsss fw-400 text-grey-500 lh-28 mt-0 mb-0 ">“Sangat membantu banget kak, dulu saat melakukan proses interview jawabnya sesuai dengan pemikiran saya saja, ternyata pemikirian saya gak semuanya itu benar. Dan setelah mengikuti arahan kelas private ini sangat membantu saya kedepannya”</p>
                        </div>
                    </div>
                    ...
                    <div class="owl-items text-center my-5">
                        <div class="card w-100 p-4 p-md--5 text-left border shadow-xs rounded-lg">
                            <div class="card-body pl-0 pt-0">
                                ...
                                <h5 class="font-xssss fw-500 mb-1 text-grey-500">Institute Pertanian Bogor , 25+ IT Infrastucture</h5>
                            </div>
                            <p class="font-xsss fw-400 text-grey-500 lh-28 mt-0 mb-0 ">“Event di Makin Mahir sangat bermanfaat, bisa di ikuti dari mana pun, mudah di pahami dan menarik topik- topiknya.”</p>
                        </div>
                    </div>
                    ...
                    <div class="owl-items text-center my-5">
                        <div class="card w-100 p-4 p-md--5 text-left border shadow-xs rounded-lg">
                            <div class="card-body pl-0 pt-0">
                                ...
                                <h5 class="font-xssss fw-500 mb-1 text-grey-500">Politeknik Negeri Lampung , Analis Labolatorium</h5>
                            </div>
                            <p class="font-xsss fw-400 text-grey-500 lh-28 mt-0 mb-0 ">“Intinya sejak selesai ikut seminar dulu itu dan banyak masukan di bedah cv, atas dasar kritik di bedah cv dulu akhirnya saya rombaklah itu cv, ada perbedaan antara sebelum & sesudah dirombak, salah satunya perbandingan antara kirim lamaran kerja dengan dipanggil wawancara cukup meningkat”</p>
                        </div>
                    </div>
                    ...
                    <div class="owl-items text-center my-5">
                        <div class="card w-100 p-4 p-md--5 text-left border shadow-xs rounded-lg">
                            <div class="card-body pl-0 pt-0">
                                ...
                                <h5 class="font-xssss fw-500 mb-1 text-grey-500">Universitas Semarang</h5>
                            </div>
                            <p class="font-xsss fw-400 text-grey-500 lh-28 mt-0 mb-0 ">“Saya sangat terbantu sekali dengan adanya Webinar kemarin kak , saya lebih bisa memahami bagaimana perkembangan antr CV ats maupun kreatif ..Dan juga sangat membantu dalam melihat yg di perlukan di perusahaan menengah, atas dll .
