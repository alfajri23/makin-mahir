            ...
            <div class="card border-left-primary shadow h-100 py-2">
                ...
                <div class="px-3">
                    <div class="btn-group" role="group" aria-label="Basic example">
                        <a href="{{route('konsultasiExpertDetails',$dt->id)}}" class="btn btn-sm btn-primary">
    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-body">
            <div class="mb-3">
                ...
                <input type="hidden" name="id_expert" id="id_expert" value="{{\Session::get('auth.id_expert')}}" class="form-control">
            </div>
            <div class="mb-3">
