            ...
            <div class="col-xl-7 vh-100 align-items-center d-flex bg-white rounded-lg overflow-hidden">
                <div class="card shadow-none border-0 ml-auto mr-auto login-card">
                    <div class="card-body rounded-0 text-left">
                        ...
                        <form method="POST" action="{{ route('testinput') }}">
                            @csrf
                            ...
                            <div class="form-group icon-input mb-2">
                                ...
                                <input type="tel" placeholder="081897234771" maxlength="13" class="style1-input pl-5 form-control text-grey-900 font-xsss fw-600" placeholder="Telepon" name="telepon" value="{{ old('telepon') }}" required autocomplete="telepon" autofocus>                        
                                @error('telepon')
                                    <span class="" role="alert alert-danger">
                                        <small  class="text-danger">{{ $message }}</small>
                                    </span>
                            ...
                            <div class="form-group icon-input mb-3">
                                <input type="Password" class="style1-input pl-5 form-control text-grey-900 font-xsss fw-600" placeholder="Password" name="password" required autocomplete="new-password">
                            ...
                            <div class="form-group icon-input mb-1">
                                <input type="Password" class="style1-input pl-5 form-control text-grey-900 font-xsss fw-600" placeholder="Confirm Password" name="password_confirmation" required autocomplete="new-password">
                                <i class="font-sm ti-lock text-grey-500 pr-0"></i>
                            </div>
